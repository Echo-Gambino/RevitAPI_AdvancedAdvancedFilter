namespace AdvAdvFilter
{
    ...
    class TreeViewController
    {
        ...
        private List<ElementId> selNodeId;
    ...
    class ElementSelectionController
    {
            ...
            )
        {
            ...
            this.treeViewController = new TreeViewController(this.treeView);
        }
        ...
        public void UpdateTreeView(List<ElementId> elements, RevitController rCon)
        {
            ...
            lock (treeLock)
            {
                this.treeViewController.UpdateTreeViewStructure(elements, rCon);
